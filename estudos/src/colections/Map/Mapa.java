...
public class Mapa {
	...
	public static void main(String[] args) {
		...
		System.out.println(usuarios.keySet());// retorna os elementos das chaves EX: 1,2,3,4, NÃO É ORDENADO, CASO ORDENAR USAR O SORTEDSET
		...
		System.out.println(usuarios.get(4)); // consulta a chave através do valor SUPER IMPORTANTE
		...
		//O PACOTE DO ENTRY É O JAVA,UTIL.MAP
